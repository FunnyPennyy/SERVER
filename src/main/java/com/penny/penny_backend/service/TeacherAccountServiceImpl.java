...
public class TeacherAccountServiceImpl implements TeacherAccountService {
    ...
    @Override
    public TeacherAccount createAccount(Long teacherId, String nickname, int initialAmount, String accountNum) {
        // 비즈니스 로직: 통장 생성 전 유효성 검사 또는 기타 작업
        // initialAmount 몇으로 설정?
        TeacherAccount teacherAccount = new TeacherAccount(teacherId, nickname, initialAmount, accountNum);
