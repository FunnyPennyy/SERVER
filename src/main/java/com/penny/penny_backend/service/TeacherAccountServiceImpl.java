...
//    private final AccountService accountService;
    ...
    public TeacherAccountServiceImpl(TeacherRepository teacherRepository,
                                     ...
                                     JobRepository jobRepository, AccountHistoryService accountHistoryService) {
...
//        this.accountService = accountService;
    ...
    public void paySalaryToStudents(Long teacherId) {
        ...
        for (Student student : students) {
            ...
            // 학생 계좌 내역 추가
            accountHistoryService.addStudentAccountHistory(account, "월급", salary, false, teacherId,
                    student.getStudentName(), teacher.getTeacherName());

            // 변경된 계좌 정보를 저장
            accountRepository.save(account);

            accountHistoryService.addTeacherAccountHistory(teacherAccount, "월급 지급", salary, true,
                    student.getStudentId(), teacher.getTeacherName(), student.getStudentName());
